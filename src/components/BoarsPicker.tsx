...
export const BoarPicker: React.FC<BoarPickerProps> = ({ 
    ...
    const [boarOptions, setBoarOptions] = useState<{ label: string; value: number }[]>([]);
            ...
            >
                <Pressable style={styles.overlay} onPress={() => setVisible(false)}>
                    <View style={styles.sheet}>
                        ...
                        >
                            <Text style={[styles.optionText, styles.optionAll]}>— Sin seleccionar —</Text>
                        </Pressable>
                        <TextInput
                        ...
                        {filteredBoars.map((opt) => (
                            ...
                            >
                                <Text style={[ styles.optionText, value === opt.value && styles.optionSelected ]}> {opt.label}</Text>
                            </Pressable>
                        ))}
                    </View>
                </Pressable>
