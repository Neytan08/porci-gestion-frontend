...
import { View, Modal, StyleSheet, TextInput, Text, TouchableOpacity, ActivityIndicator, Alert, FlatList, Pressable } from "react-native";
import { getBreed, createBreed } from "../api/breedApi";
import type { Breed } from "../api/breedApi";
import { areStringsEqual, containsSpecialCharacters } from "../utils/stringHelpers";
...
export const BreedDropdown: React.FC<BreedDropdownProps> = ({ value, onChange }) => {
  ...
  const handleCreateBreed = async () => {
    ...
    if (!newBreed.breed_name.trim() || containsSpecialCharacters(newBreed.breed_name)) {
      Alert.alert("Error", "El nombre de la raza es obligatorio y no debe contener caracteres especiales.");
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.breedRow}>
        ...
        <TouchableOpacity onPress={() => setBreedOptionsModalVisible(true)} style={styles.breedDropdown}>
      ...
      <Modal 
        ...
        <Pressable 
          ...
          <View style={{...styles.modalContainer}}>
            <View style={{...styles.modalView, maxHeight: '80%', paddingBlockEnd: 10}}>
      ...
      <Modal visible={addingModalVisible} transparent animationType="slide">
        <View style={styles.modalContainer}>
          <View style={{...styles.modalView, paddingHorizontal: 15, paddingVertical: 10}}>
            ...
            <View style={styles.addingModalViewButtons}>
              <TouchableOpacity style={styles.addingModalButtons} onPress={ () => handleCreateBreed()}>
