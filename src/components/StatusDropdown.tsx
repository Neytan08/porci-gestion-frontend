...
import { View, Text, StyleSheet, ActivityIndicator, TouchableOpacity, Modal, FlatList, Pressable } from "react-native";
...
export const StatusDropdown: React.FC<StatusDropdownProps> = ({ value, onChange }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={() => setStatusModalVisible(true)} style={styles.dropdown}>
                <Text style={styles.selectedStatus}>
                    {statusOptions.find((item) => item.value === value)?.label || "Seleccionar estado..."}
                </Text>
            </TouchableOpacity>
            ...
            <Modal
                ...
                <Pressable style={styles.statusOverlay} onPress={() => setStatusModalVisible(false)}>
                    {/* Modal content */}
