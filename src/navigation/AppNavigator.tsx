  ...
  return (
    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: true }}>
        ...
        <Stack.Screen name="EditBoar" component={EditBoar} options={{ title: "Editar Verraco", headerStyle: { backgroundColor: '#2E7D32'}, headerTintColor: '#FFFFFF'}} />
        <Stack.Screen name="MatingEvents" component={MattingEventsScreen} options={{ title: 'Inseminaciones o Montas', headerStyle: { backgroundColor: '#2E7D32'}, headerTintColor: '#FFFFFF'}} />
        <Stack.Screen name="AddMatingEvent" component={AddMatingEventScreen} options={{ title: 'Agregar Inseminación o Monta', headerStyle: { backgroundColor: '#2E7D32'}, headerTintColor: '#FFFFFF'}} />
        <Stack.Screen name="EditMatingEvent" component={EditMatingEventScreen} options={{ title: 'Editar Inseminación o Monta', headerStyle: { backgroundColor: '#2E7D32'}, headerTintColor: '#FFFFFF'}} />
        <Stack.Screen name="DetailsMatingEvent" component={DetailsMatingEventScreen} options={{ title: 'Detalles Inseminación o Monta', headerStyle: { backgroundColor: '#2E7D32'}, headerTintColor: '#FFFFFF'}} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
