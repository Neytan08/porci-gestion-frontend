...
import InseminationTypePicker, { InseminationType } from "../../components/InseminationTypeDropdown";
import PregnancyResultPicker, { PregnancyResult } from "../../components/PregnancyResultDropdown";
import { BreedingSowPicker } from "../../components/BreedingSowPicker";
import { BoarPicker } from "../../components/BoarsPicker";
...
export default function AddMatingEventScreen() {
  ...
  const handleSubmit = async () => {
      try {
        ...
        if (!finalData.sow_id || !finalData.insemination_date || !finalData.insemination_type || !finalData.pregnancy_result) {
