...
export default function SowsScreen() {
	...
	const [filterSelectedBreedId, setFilterSelectedBreedId] = useState<
		number | null
	>(null);
	const [filterSelectedStatusId, setFilterSelectedStatusId] = useState<
		number | null
	>(null);
	...
	const filterSows = useMemo(() => {
		return sows.filter((s) => {
			...
			const matchStatus =
				filterSelectedStatusId == null || statusId === filterSelectedStatusId;
			...
			<SafeAreaView style={styles.mainContainer}>
							...
							<View style={styles.filterBtnRow}>
								<Pressable
									...
									onPress={() => {
										...
										setFilterSelectedStatusId(null);
				...
				<FlatList<Sow>
					...
					renderItem={({ item }) => {
						...
						const isActive =
							sowAction?.sow_id === item.sow_id && actionsModalVisible;
						...
						return (
							<Pressable
								...
								onLongPress={() =>
									handleDeletePress(item.sow_id, item.sow_tag_number)
								}
							>
								{/* FlatList Content */}
								<View
					...
					<View style={styles.modalActionsContainer}>
						...
						<View style={styles.modalActionsView}>
							<Text style={{ fontWeight: "700", marginBottom: 8 }}>
								...
								{sowAction?.sow_tag_number ?? sowAction?.sow_id}
							</Text>
							<View
								style={{
									flexDirection: "row",
